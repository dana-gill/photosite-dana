...
export const handler = define.handlers({
  GET: async (ctx) => {
    const images = await getImagesByAlbum(ctx.state.kv, "ornate") ?? [];
    return { data: images };
  },
});

export default define.page<typeof handler>(
  function Ornate({ data }) {
    const images = data;
    ...
    return (
      <div class="px-4 py-8 mx-auto md:min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto">
          <PageHeader title="Ornate" subtitle="Detailed architecture through Italy and the South of France. 2022 - Current." />
